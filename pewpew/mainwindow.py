...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def actionToolCalculator(self) -> None:
        ...
        name = f"Calculator: {widget.laser.info['name']}"
    ...
    def actionToolDrift(self) -> None:
        ...
        name = f"Drift: {widget.laser.info['name']}"
        widget.view.removeTab(index)
        widget.view.insertTab(index, name, tool)
        tool.setActive()
    ...
    def actionToolFilter(self) -> None:
        ...
        name = f"Filter: {widget.laser.info['name']}"
        widget.view.removeTab(index)
        widget.view.insertTab(index, name, tool)
        tool.setActive()
    ...
    def actionToolStandards(self) -> None:
        ...
        name = f"Standards: {widget.laser.info['name']}"
        widget.view.removeTab(index)
        widget.view.insertTab(index, name, tool)
        tool.setActive()
    ...
    def actionToolOverlay(self) -> None:
        ...
        name = f"Overlay: {widget.laser.info['name']}"
        widget.view.removeTab(index)
        widget.view.insertTab(index, name, tool)
        tool.setActive()
